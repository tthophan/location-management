...
export class Migrations1745423695301 implements MigrationInterface {
  name = 'Migrations1745423695301';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.startTransaction();
    await queryRunner.query(
      `CREATE TABLE "locations" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "location_number" character varying NOT NULL, "building" character varying NOT NULL, "area" double precision NOT NULL, "parent_id" integer, "level" integer NOT NULL, CONSTRAINT "PK_7cc1c9e3853b94816c094825e74" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "locations" ADD CONSTRAINT "FK_ce8370570fc9bb582e9510b94a0" FOREIGN KEY ("parent_id") REFERENCES "locations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    ...
    await queryRunner.query(`
        INSERT INTO "locations" 
          ("id", "name", "description", "location_number", "building", "area", "level", "parent_id") 
        VALUES 
